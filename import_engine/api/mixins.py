...
class ImportMixin:
    ...
    def get_import_model_name(self):
        ...
        raise ValueError("ImportMixin requires either `import_model_name` or `queryset` on the ViewSet.")
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(description="Excel file.", response=OpenApiTypes.BINARY),
            404: OpenApiResponse(description="Model not registered.")
        }
    )
