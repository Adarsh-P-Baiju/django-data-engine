...
urlpatterns = [
    path('imports/<str:model_name>/template/', TemplateDownloadView.as_view(), name='import_template'),
    path('imports/<str:model_name>/upload/', ImportUploadView.as_view(), name='import_upload'),
